function Sidebar({ activeView, onViewChange, onNewTask, theme, onThemeToggle }) {
    try {
        const navItems = [
        ...
        return (
            <aside className="w-60 h-screen glass-panel flex flex-col p-4" data-name="sidebar" data-file="components/Sidebar.js">
                ...
                <button onClick={onThemeToggle} className="mt-auto px-3 py-2 rounded-xl flex items-center gap-3 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-smooth">
